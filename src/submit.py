...
class Submission(Base):
    def __init__(self, api_key):
        ...
        self._records_url = 'https://api-dev.nestquant.com/' + f'competition/nestquant_tournament_2023/records/api?api_key=' + self._api_key
        self._result_url = 'https://api-dev.nestquant.com/' + f'competition/nestquant_tournament_2023/result/api?&api_key=' + self._api_key
        self._submit_url = 'https://api-dev.nestquant.com/' + f'competition/nestquant_tournament_2023/submit/api?api_key=' + self._api_key
